...
Remove-Item -Path 'D:\Learning\QuckApp\mobile\android\app\build' -Recurse -Force -ErrorAction SilentlyContinue
Remove-Item -Path 'D:\Learning\QuckApp\mobile\android\.gradle' -Recurse -Force -ErrorAction SilentlyContinue
